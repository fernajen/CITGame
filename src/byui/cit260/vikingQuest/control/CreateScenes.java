...
public class CreateScenes {
    ...
    public static Scene[] createScenes() throws MapControlException{
        ...
        ImageIcon startingSceneImage = MapControl.getImage(startScene,
                    "/citbyui/cit260/vikingquest/images/startingPoint.jpg");
        ...
        ImageIcon finishSceneImage = MapControl.getImage(finishScene,
                "/citbyui/cit260/vikingquest/images/finish.jpg");
            finishingScene.setIcon(finishSceneImage);
